import{a as G}from"./axios-G2rPRu76.js";import{l as K}from"./PageWrapper-FKZhqcit.js";async function F(){return K.getItem("gemeni-api-key")}async function ue(e){return K.setItem("gemeni-api-key",e)}async function P(e){const n=await F();return e.params.key=n,e}const B=G.create({baseURL:"https://generativelanguage.googleapis.com/v1"});B.interceptors.request.use(P);const Y=G.create({baseURL:"https://generativelanguage.googleapis.com/v1beta"});Y.interceptors.request.use(P);/**
 * @license
